...
analysis <- "Schaefer"
resfile <- setuphtml(resdir=resdir,cleanslate=TRUE)
...
addtable(intable=schaef,filen=filen,resdir=resdir,category="data",
...
addtable(intable=sortyft,filen=filen,resdir=resdir,category="data",
         caption="The Schaefer 1957 data sorted on catch.")

# plot the timeseries of cpue and catch,  only png files
filename <- filenametopath(resdir,"Schaefer_Fisherydata.png")
...
addplot(filen=filename,resdir=resdir,category="Fishery",caption=caption)  

# plot the catch against the effort
filename <- filenametopath(resdir,"Schaefer_CatchvEffort.png")
...
filename <- filenametopath(resdir,"Schaefer_Effortdata.png")
...
addplot(filen=filename,resdir=resdir,category="Effort",caption=caption)  
