...
resdir <- filenametopath(indir,"result") # pretty poor resdir name!
dirExists(resdir,verbose=TRUE)  # this creates the directory if needed
runlabel <- "runone"
...
parset(plots=c(2,1))   # read the help pages on plotprep and parset
ymax <- getmax(schaef$cpue)  # you do not need to use base graphics
...
# currently for plots you need to log the filenames manually.
